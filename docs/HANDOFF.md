...
Última atualização: 2026-09-25 · Claude Code · 7.3 (perfil e residência) no PR draft [#34](https://github.com/johnberks/dokh/pull/34) (`codex/7.3-onboarding-profile`), empilhado sobre o [#33](https://github.com/johnberks/dokh/pull/33) (7.1, confirmado no iPhone pelo usuário). A 3.1 segue pendente da conexão real do app preview.
