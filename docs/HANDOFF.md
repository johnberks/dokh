...
| 2.5 Componentes de domínio visual | 🟡 Review Card no PR draft #7, Trabalho no #8, ReceivableRow no #9 e EmptyState no #10 | Seis componentes restantes, aplicação em telas e inspeção de aparelho depois |
