...
| 2.5 Componentes de domínio visual | 🟡 Review Card no PR draft #7, Trabalho no #8 e ReceivableRow no #9 | Sete componentes restantes, aplicação em telas e inspeção de aparelho depois |
