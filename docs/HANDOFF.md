...
Última atualização: 2026-09-22 · Codex · 3.3 concluída na branch `codex/3.3-professional-core`, empilhada sobre o PR draft [#18](https://github.com/johnberks/dokh/pull/18). A 3.1 segue pendente da conexão real do app preview.
...
O ponto de retomada desta trilha é a branch `codex/3.3-professional-core`, empilhada sobre o PR draft [#18](https://github.com/johnberks/dokh/pull/18). A 3.3 está concluída. A 3.1 está **parcial**: configuração e testes de ambiente prontos, mas sem prova da DoD. Na base, **todos os componentes da 2.5 existem**; a 2.5 continua desmarcada até aplicação nas telas reais e validação em aparelho.
...
```bash
git fetch origin codex/3.3-professional-core
git switch -c codex/3.3-professional-core origin/codex/3.3-professional-core
fnm exec --using=22 npm ci
