...
Última atualização: 2026-09-25 · Claude Code · 7.4 (primeiro Trabalho) na branch `codex/7.4-first-work`, sobre o PR [#35](https://github.com/johnberks/dokh/pull/35) (6.1/6.2). A 3.1 segue pendente da conexão real do app preview.
...
| 7.4 Primeiro Trabalho | 🟡 Telas de tipo, local, quando e valor, com gravação atômica e idempotente | Validar no iPhone com Supabase local; conclusão dinâmica é a 7.5 |
