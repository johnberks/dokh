...
Última atualização: 2026-09-25 · Claude Code · 6.1/6.2 (camada de dados de Locais e Trabalho) na branch `codex/6.1-work-data`, sobre o PR [#34](https://github.com/johnberks/dokh/pull/34) (7.3, aprovada no iPhone pelo usuário). A 3.1 segue pendente da conexão real do app preview.
...
| 6.1 Dados de Locais | 🟡 Lista, criação com cor automática, edição e arquivamento tipados | Exercitar contra o Supabase local pelas telas (7.4 e Fase 8) |
| 6.2 Dados de Trabalho/Recebível | 🟡 RPCs atômicas, confirmação de recebimento, idempotência e invalidação | Exercitar contra o Supabase local pelas telas (7.4 e Fase 8) |
