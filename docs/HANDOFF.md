...
Última atualização: 2026-09-23 · Codex · Correções dos gestos do catálogo adicionadas ao PR draft [#28](https://github.com/johnberks/dokh/pull/28), empilhado sobre o [#27](https://github.com/johnberks/dokh/pull/27). A 3.1 segue pendente da conexão real do app preview.
